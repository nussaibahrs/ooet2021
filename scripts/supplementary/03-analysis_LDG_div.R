# Computes and plots LDG at species level for each plankton group
...
save(LDG_div, file=file.path("output", "LDG_div.RData"))

#### plot data ####
load(file.path("output", "LDG_div.RData"))
